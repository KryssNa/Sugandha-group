  ...
  return (
    <section className='deals pb-120'>
      <div className='container container-lg'>
        <div
          className='bg-neutral-600 rounded-48 bg-img bg-gradient-to-r from-[#e9dfd1] via-[#b5a388] to-[#826740]'
              ...
              <div className='position-relative px-24'>
                <ul className='products-group'>
                  <li className='products-group__list pt-12'>
                    <span className='w-32 h-32 border-white rounded-circle flex-center position-relative overflow-hidden border-2 bg-blur cursor-pointer'>
                ...
                <div className='text-end'>
                  <img
                    src='assets/images/herosection/coverimage.svg'
                    alt=''
